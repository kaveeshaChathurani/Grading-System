                ...
                if Fail_credit in [20 * i for i in range(7)]:
                    if Pass_credit + Defer_credit + Fail_credit == 120:
                        ...
                        if (yesq == "q"):
                            ...
                            print("------------------------------------------------------------------------")
                            print(" ")
                            print("Vertical Histogram")#https://stackoverflow.com/
                            print(" ")
                            ...
                            my_file= open("my_file.txt","a")#https://www.datacamp.com/community/tutorials/reading-writing-files-python
                            
                            for i in range(Progress):
                               my_file.write(str("Progress :"))  
                               my_file.write(str(Progre[i]))
                               my_file.write("\n")
                           
                            for i in range(Progress_module_trailer):
                               my_file.write(str("Progress (module trailer) :"))
                               my_file.write(str(Trailer[i]))
                               my_file.write("\n")
                           
                            for i in range(Module_retriever):
                               my_file.write(str("Module retriever :"))
                               my_file.write(str(Retriever[i]))
                               my_file.write("\n")
                           
                            for i in range(Exclude):
                               my_file.write(str("Exclude :")) 
                               my_file.write(str(Excluded[i]))
                               my_file.close()
